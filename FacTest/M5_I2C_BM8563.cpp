...
bool I2C_BM8563::isEnable(uint8_t deviceAddress) {
...
void I2C_BM8563::setDate(I2C_BM8563_DateTypeDef *I2C_BM8563_DateStruct) {
    ...
    if (I2C_BM8563_DateStruct->year < 2000) {
        ...
        _i2cPort->write(
            byteToBcd2((uint8_t)(I2C_BM8563_DateStruct->year % 100)));
    } else {
...
int I2C_BM8563::SetAlarmIRQ(
    const I2C_BM8563_DateTypeDef &I2C_BM8563_DateStruct,
    const I2C_BM8563_TimeTypeDef &I2C_BM8563_TimeStruct) {
    uint8_t irq_enable = false;
    uint8_t out_buf[4] = {0x80, 0x80, 0x80, 0x80};
...
void I2C_BM8563::WakeAfterSeconds(int afterSeconds) {
...
int I2C_BM8563::WakeChecksum(int afterSeconds) {
    uint8_t reg_value      = 0;
    uint8_t get_value_01_h = 0;
    uint8_t get_value_0e_h = 0;
    uint8_t get_value_0f_h = 0;
    ...
    afterSeconds       = (afterSeconds / div) & 0xFF;
    rtc_reg_value_0f_h = afterSeconds;
    rtc_reg_value_0e_h = type_value;

    rtc_reg_value_01_h = 0x01;

    get_value_01_h = ReadReg(0x01);
